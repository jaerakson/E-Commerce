...
export const metadata: Metadata = { title: "Contact — AETHER" };
...
<input className="input-field w-full p-4 font-body-md text-body-md" id="firstName" placeholder="Enter your first name" type="text"/>
</div>
<div>
<label className="font-label-caps text-label-caps text-silver-mist block mb-2" htmlFor="lastName">Last Name</label>
<input className="input-field w-full p-4 font-body-md text-body-md" id="lastName" placeholder="Enter your last name" type="text"/>
</div>
</div>
<div>
<label className="font-label-caps text-label-caps text-silver-mist block mb-2" htmlFor="email">Email Address</label>
<input className="input-field w-full p-4 font-body-md text-body-md" id="email" placeholder="Enter your email address" type="email"/>
</div>
<div>
<label className="font-label-caps text-label-caps text-silver-mist block mb-2" htmlFor="inquiryType">Inquiry Type</label>
<select className="input-field w-full p-4 font-body-md text-body-md appearance-none" id="inquiryType">
<option defaultValue="general">General Inquiry</option>
<option defaultValue="order">Order Status</option>
<option defaultValue="appointment">Book an Appointment</option>
<option defaultValue="press">Press &amp; Media</option>
</select>
</div>
<div>
<label className="font-label-caps text-label-caps text-silver-mist block mb-2" htmlFor="message">Message</label>
<textarea className="input-field w-full p-4 font-body-md text-body-md resize-none" id="message" placeholder="How can we assist you?" rows={5}></textarea>
</div>
<button className="btn-primary w-full py-4 font-label-caps text-label-caps uppercase tracking-wider" type="submit">Submit Inquiry</button>
</form>
</div>
</div>
...
<div className="accordion-item bg-pitch-black border border-surface-variant p-4 cursor-pointer">
<div className="flex justify-between items-center">
<h4 className="font-body-lg text-body-lg text-pure-white">What is your return policy?</h4>
<span className="material-symbols-outlined accordion-icon text-silver-mist">expand_more</span>
</div>
<div className="accordion-content mt-2">
<p className="font-body-md text-body-md text-silver-mist">We accept returns within 14 days of delivery for a full refund, provided items remain in pristine condition with original tags attached.</p>
</div>
</div>
<div className="accordion-item bg-pitch-black border border-surface-variant p-4 cursor-pointer">
<div className="flex justify-between items-center">
<h4 className="font-body-lg text-body-lg text-pure-white">Do you offer international shipping?</h4>
<span className="material-symbols-outlined accordion-icon text-silver-mist">expand_more</span>
</div>
<div className="accordion-content mt-2">
<p className="font-body-md text-body-md text-silver-mist">Yes, we ship globally via insured courier services. Duties and taxes are calculated at checkout based on the destination.</p>
</div>
</div>
<div className="accordion-item bg-pitch-black border border-surface-variant p-4 cursor-pointer">
<div className="flex justify-between items-center">
<h4 className="font-body-lg text-body-lg text-pure-white">How can I book a private viewing?</h4>
<span className="material-symbols-outlined accordion-icon text-silver-mist">expand_more</span>
</div>
<div className="accordion-content mt-2">
<p className="font-body-md text-body-md text-silver-mist">Private viewings can be arranged at our flagship locations by selecting 'Book an Appointment' in the contact form above.</p>
</div>
</div>
</div>
</div>
