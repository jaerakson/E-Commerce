...
<a className="text-on-surface-variant hover:text-pure-white transition-colors" href="#">Collections</a>
<a className="text-on-surface-variant hover:text-pure-white transition-colors" href="#">New Arrivals</a>
<a className="text-on-surface-variant hover:text-pure-white transition-colors" href="#">Curations</a>
<a className="text-on-surface-variant hover:text-pure-white transition-colors" href="#">Boutique</a>
</nav>
...
<span className="material-symbols-outlined hover:text-primary transition-all duration-300 cursor-pointer" data-icon="person">person</span>
</div>
</div>
</header>
